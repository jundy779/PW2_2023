...
<body>
  ...
  <form method="GET" action="form_belanja.php" class="w-75 mt-5 mx-auto p-4 border shadow-sm">
    ...
    <div class="container px-3">
      <div class="form-group row">
        ...
        <div class="col-8">
          <input name="customer_name" placeholder="Masukan nama customer" type="text" class="form-control" required>
        </div>
      </div>
      <div class="form-group row">
        ...
        <div class="col-8">
          <div class="custom-control custom-radio custom-control-inline">
            <input value="baju" name="produk" type="radio" class="custom-control-input" required>
            <label for="produk" class="custom-control-label">Baju</label>
          </div>
          <div class="custom-control custom-radio custom-control-inline">
            <input value="topi" name="produk" type="radio" class="custom-control-input" required>
            <label for="topi" class="custom-control-label">Topi</label>
          </div>
          <div class="custom-control custom-radio custom-control-inline">
            <input value="jamtangan" name="produk" type="radio" class="custom-control-input" required>
  ...
  if (isset($_GET['submit'])) {
    // variable untuk menyimpan vallue
